...
namespace Dan.Demo
{
    public class LeaderboardShowcase : MonoBehaviour
    {
        ...
        public void Load()
        {
            ...
            _pageInput.textComponent.color = Color.yellow;
            _entriesToTakeInput.textComponent.color = Color.yellow;


            
            Leaderboards.TestLeaderboard.GetEntries(searchQuery, OnLeaderboardLoaded, ErrorCallback);
        ...
        private void InitializeComponents()
        {
            ...
            _pageInput.onValueChanged.AddListener(_ => _pageInput.textComponent.color = Color.yellow);
            _entriesToTakeInput.onValueChanged.AddListener(_ => _entriesToTakeInput.textComponent.color = Color.yellow);
            ...
            _pageInput.text = _defaultPageNumber.ToString();
            _entriesToTakeInput.text = _defaultEntriesToTake.ToString();
        }
        ...
        public void Submit()
        {
            Leaderboards.TestLeaderboard.UploadNewEntry(_playerUsernameInput.text, _playerScore, Callback, ErrorCallback);
        }
        
        public void DeleteEntry()
        {
            Leaderboards.TestLeaderboard.DeleteEntry(Callback, ErrorCallback);
        }
        ...
        {
            Leaderboards.TestLeaderboard.GetPersonalEntry(OnPersonalEntryLoaded, ErrorCallback);
        }
